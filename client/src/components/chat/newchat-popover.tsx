...
// ou est le bouton ou case cocher pour passer a group mode et revenir en arriere ?
// l input pour le nom du groupe et pour la recherche dans les deux mode ?
// comment fermet le poopover
// 
...
const UserAvatar = memo(({ user }: { user: UserType }) => ( // a quoi ca sert c est quoi ca pourquoi tous ses memo dans c est dossier a quoi il sert tous, qui utilise ceci
  <>
...
UserAvatar.displayName = "UserAvatar"; // ca veut dire quoi

const NewGroupItem = memo( // qui utilise ceci ou on place ceci 
...
NewGroupItem.displayName = "NewGroupItem"; // ca veut dire quoi

const ChatUserItem = memo( // ou est ce qu on place normalement on place ceci dans un map
  ({
    user,
    isLoading,
    disabled,
...
ChatUserItem.displayName = "ChatUserItem"; // ca veut dire quoi

const GroupUserItem = memo( // ou est ce qu on place normalement on place ceci dans un map
  ({
    user,
    isSelected,
    onToggle,
...
GroupUserItem.displayName = "GroupUserItem"; // ac veut dire quoi 

// ou est la fonction qui utilise tous ses memo 

// et expliquer les conditions qui les fait poop et unpoop ou sont les code qui font ca ?
